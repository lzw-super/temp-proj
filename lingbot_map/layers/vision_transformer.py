...
class DinoVisionTransformer(nn.Module):
    ...
    def prepare_tokens_with_masks(self, x, masks=None):
        B, nc, w, h = x.shape
        x = self.patch_embed(x)  #常规的patch embedding 294x518 -> 777x1024   294x518 = 777x14x14
    ...
    def forward_features(self, x, masks=None):
        ...
        x = self.prepare_tokens_with_masks(x, masks)  #dino的基础编码 clstoken+regtokens+patchtokens 以及位置编码信息
